...
<!-- begin::Settings -->
<x-sidebar-link href="{{ route('settings') }}" active="{{ request()->route()->named('settings') || request()->route()->named('halls.booking-times.index') || request()->route()->named('halls.offers.index') }}">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
