...
<!-- begin::Settings -->
<x-sidebar-link href="{{ route('admin.settings') }}" active="{{ request()->route()->named('admin.settings') || request()->route()->named('packages.index') || request()->route()->named('features.index') || request()->route()->named('business-fields.index') }}">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
