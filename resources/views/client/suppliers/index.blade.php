<x-app-layout>
    ...
    <x-slot name="header" class="py-6">
        ...
        <x-actions.add href="{{ route('halls.suppliers.create', session('hall')->id) }}" />
    </x-slot>
    <!-- end::Page Heading -->
        ...
        @foreach ($suppliers as $supplier)
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm space-s-1 flex items-center justify-end">
                    <!-- begin::Edit -->
                    <x-actions.edit href="{{ route('halls.suppliers.edit', ['hall' => session('hall')->id, 'supplier' => $supplier->id]) }}"/>
                    <!-- end::Edit -->

                    <!-- begin::Delete -->
                    <x-actions.delete action="{{ route('halls.suppliers.destroy', ['hall' => session('hall')->id, 'supplier' => $supplier->id]) }}"/>
                    <!-- end::Delete -->
                </td>
                <!-- end::Actions -->
            </tr>
